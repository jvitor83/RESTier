...
namespace Microsoft.Restier.Core
{
    ...
    public class RestierContainerBuilder : IContainerBuilder
    {
        ...
        public virtual IServiceProvider BuildContainer()
        {
            ...
            TypeInfo serviceCollectionContainerBuilderExtensionsType = microsoftExtensionsDependencyInjectionAssembly
                   .GetType(typeof(ServiceCollectionContainerBuilderExtensions).GetTypeInfo().FullName).GetTypeInfo();
            MethodInfo buildServiceProviderMethod = serviceCollectionContainerBuilderExtensionsType
                                             .GetMethod("BuildServiceProvider", new[] { typeof(IServiceCollection) });
